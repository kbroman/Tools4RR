...
\centerline{\includegraphics[height=0.8\textheight]{Figs/iso_8601.png}}

\vfill

\hfill {\footnotesize \lolit \href{http://xkcd.com/1179/}{xkcd}}
...
\note{Refer to Hadley Wickham's paper.
}
\end{frame}
...
\item Consider symbolic links for shared data files/directories
\bi
...
\note{Ideally, everything with git/GitHub.
...
\note{Use git yourself, and copy over your stuff to a common
  spot...preferably an automated system for the copying-over.
}
\end{frame}
...
\note{I said this in the notes on the previous page; it's worth
  emphasizing again.
