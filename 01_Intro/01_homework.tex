...
\item Install a bunch of software on your laptop.
  ...
  \item Windows
    ...
    \item \href{http://miktex.org/download}{MikTeX} (for LaTeX)
      (You'll want to add MikTex to your {\ttsm PATH}; see
      \href{http://superuser.com/questions/502358/easier-way-to-change-environment-variables-in-windows-8}{this page}.)
    \end{itemize}
  ...
  \item Mac
    ...
    \item Xcode command line tools (see
      \href{http://railsapps.github.io/xcode-command-line-tools.html}{this
        page})
    \item \href{http://git-scm.com/download/mac}{git} (or
      via \href{http://brew.sh/}{Homebrew}: {\ttsm brew install git})
    \item Perhaps \href{http://iterm2.com/}{iTerm2}
    \item \href{https://tug.org/mactex/}{MacTeX} (for LaTeX)
    \end{itemize}
