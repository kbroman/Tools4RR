...
\subtitle{KnitR with R Markdown and AsciiDoc}
...
\note{Statisticians write a lot of reports, describing the results of
  ...
  web pages. Markdown and Asciidoc are two systems for writing simple,
  readble text, with the sort of marks that you might use in an email
  message, that get converted to nicely formated html-based web pages.

  My goal in this lecture is to show you how to use Knitr with R
  Markdown (a variant of Markdown) and AsciiDoc to make such
...
\item Knitr + Markdown/AsciiDoc $\rightarrow$ Web page
\ei
...
\note{Statisticians write a lot of reports. You do a bunch of
  ...
  Web pages, produced with knitr and Markdown or Asciidoc, are ideal.
}
\end{frame}
