...
directory containing that file and type

\begin{quote}
{\tt \color{hilight} make}
\end{quote}

\item If you name your make file {\tt something.else}, then go into
  the directory containing that file and type
