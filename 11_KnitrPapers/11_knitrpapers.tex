...
\note{
  ...
  I also want to discuss some more general stategies for ensuring that
...
\item \href{http://www.xelatex.org/}{xelatex}
...
\note{
  ...
  The formatting of citations and the reference listings, to
  match what the journal wants, can be painful. But I've figured out
  what \emph{Genetics\/} wants, and I send all of my papers there.
